...
export const PROJECTS = [
  {
    ...
    shortDescription: 'A modern and fully responsive personal portfolio website designed to showcase my frontend development skills, professional experiences, featured projects, and technical expertise through a clean and interactive user interface',
    detailParagraphs: [
      'Developed a modern and responsive Portfolio Website to professionally present my frontend development journey, technical skills, work experiences, and featured projects in a visually appealing and user-friendly layout.',
  
      'The project was built using Next.js and TypeScript to ensure high performance, scalability, and smooth page rendering. Tailwind CSS was used to create a clean, responsive, and maintainable UI design system that works seamlessly across desktop, tablet, and mobile devices.',
  
      'The website includes multiple sections such as an introduction banner, about me section, work experience section, featured project showcase, detailed project pages, and a contact form for communication. Smooth scrolling navigation and modern UI interactions help improve the overall user experience.',
  
      'Implemented dark and light mode support to provide users with a comfortable viewing experience based on their preferences. The application also supports multilingual structure preparation for future localization support.',
  
      'Integrated email processing functionality for the contact form using Resend, allowing visitors to directly send messages through the website efficiently and securely.'
    ],
    keyFeatures: [
      'Fully responsive design for mobile, tablet, and desktop',
      'Dark and light mode support',
      'Multiple languages support for future localization',
      'Interactive hero section and smooth scrolling navigation',
      'Project showcase with dedicated detail pages',
      'Modern and clean UI/UX design',
      'Reusable component-based architecture',
      'Contact form with email processing integration using Resend',
      'Responsive navigation bar with smooth section transitions',
      'Scalable and maintainable frontend project structure'
    ],
    languages: [
      'Next.js',
      'TypeScript',
