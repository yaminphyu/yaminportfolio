        ...
        <div className='w-full'>
          <form className='flex flex-col gap-8'>
            <div className='w-full flex gap-4'>
              <input type="text" placeholder='Enter your name' className='w-1/2 p-2.5 rounded-md bg-[#1e0f36] border border-white/30 text-white text-sm md:text-base'/>
              <input type="email" placeholder='Enter your email' className='w-1/2 p-2.5 rounded-md bg-[#1e0f36] border border-white/30 text-white text-sm md:text-base'/>
            </div>
            <textarea
